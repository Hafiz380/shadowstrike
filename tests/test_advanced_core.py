...
''')
    ...
    def test_custom_rule(self, tmp_path):
        from strix.core.recon.custom_rules import CustomRuleEngine, Rule
...
class TestFindings:
    ...
    def test_finding_creation(self):
        from strix.core.static_analyzer.findings import Finding, FindingSeverity, FindingConfidence, FindingLocation, FindingEvidence
    ...
    def test_finding_cwe_mapping(self):
        from strix.core.static_analyzer.findings import VULN_TYPE_TO_CWE
...
class TestExploitChain:
    ...
    def test_chain_detection(self):
        from strix.core.exploitation.chain_builder import ExploitChainBuilder, Vulnerability
...
class TestWAFBypass:
    ...
    def test_sqli_bypasses(self):
        from strix.core.exploitation.waf_bypass import WAFBypass
...
class TestMemory:
    ...
    def test_scan_memory(self, tmp_path):
        from strix.core.memory.scan_memory import ScanMemory
    ...
    def test_global_memory(self, tmp_path):
        from strix.core.memory.global_memory import GlobalMemory
